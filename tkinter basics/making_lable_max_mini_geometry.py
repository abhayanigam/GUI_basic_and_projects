...
root.title("Abhays's window")

r = Label(text = "This is my first tkinter program",bg = "red",fg = "white",padx = 113,pady =94,font = "comicsansms 19 bold",borderwidth = 30,relief = RIDGE)
